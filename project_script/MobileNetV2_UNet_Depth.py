...
MODEL_NAME = 'MobileNetV2_UNet_Depth'
...
def MobileNetV2_UNet(output_channels:int):
    init_model = copyModel(MobileNetV2(input_shape=[128, 128, 3], include_top=False))
...
# Create Model A
modelA = MobileNetV2_UNet(output_channels=3)

# Create Model B
modelB = MobileNetV2_UNet(output_channels=3)
